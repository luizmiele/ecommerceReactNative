    ...
    <TouchableOpacity onPress={toggleModal}>
      <View style={styles.geral}>
        <View style={styles.imgContainer}>
          <Image style={styles.imagemCentro} source={{ uri: rest.imagem }} />
        </View>
      ...
      <Modal
        ...
        onClose={toggleModal}
        button1={rest.text1 || "Cancelar"}
        button2={rest.text2 || "Editar"}
        function1={rest.function1 || toggleModal}
        function2={rest.function2 || handlesignIn}
      />
    </TouchableOpacity>
  );
}
